export default {
  ...
  data() {
    return {
      doctorId: this.$route.params.id || this.$route.params.doctor_id,
      doctor: {},
      loading: true,
      error: null
    };
  ...
  methods: {
    ...
    goAvailability() {
        ...
        return authFetchWithRetry(`/api/department/${deptId}`, {  // ✅ authFetchWithRetry + return
            headers: { 'Content-Type': 'application/json' }
        })
        .then(res => {
